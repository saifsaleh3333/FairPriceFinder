...
export const Contact = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm("service_ppg2u36", "template_first", e.target, "S2LCNNfTM0wnZnAy0")
      .then(
        (result) => {
          ...
          <div className="col-md-8">
            <div className="row">
              <div className="section-title">
                ...
                <p>
                  Don't miss out on our latest updates and news.
                </p>
              </div>
              <form name="sentMessage" validate="true" onSubmit={handleSubmit}>
                ...
                <div className="form-group d-none">
                  <textarea name="message" id="message" className="form-control" rows="4" placeholder="Message" required
                    onChange={handleChange} value={message}>{message}</textarea>
                  <p className="help-block text-danger"></p>
                </div>
                <div id="success"></div>
